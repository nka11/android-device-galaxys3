...
-include vendor/samsung/galaxys3/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := GT-I9300
...
TARGET_GLOBAL_CPPFLAGS += -DUSE_GS3_LIBCAMERA
endif
...
TARGET_PREBUILT_KERNEL := device/samsung/galaxys3/kernel
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/galaxys3/recovery/recovery_ui.c
...
# assert
TARGET_OTA_ASSERT_DEVICE := galaxys3,GT-I9300
